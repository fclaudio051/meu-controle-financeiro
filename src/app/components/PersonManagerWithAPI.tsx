    ...
    <div className="bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-white/20 pb-20">
      ...
      <div className="flex gap-4 mb-8">
        <input
          ...
          className="flex-1 border-2 border-gray-200 rounded-xl px-5 py-4 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 bg-white/90 backdrop-blur font-medium shadow-sm text-gray-800"
