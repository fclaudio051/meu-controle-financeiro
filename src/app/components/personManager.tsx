      ...
      <div className="bg-gradient-to-br from-white/90 to-gray-50/90 backdrop-blur-md card-responsive shadow-2xl border border-white/20 w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-6 sm:mb-8">
          <input
            ...
            className="flex-1 border-2 border-gray-200 rounded-xl px-4 sm:px-5 py-3 sm:py-4 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 bg-white/90 backdrop-blur font-medium shadow-sm text-sm sm:text-base"
          ...
          <button
            ...
            className="btn-responsive sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 disabled:from-gray-300 disabled:to-gray-400 text-white font-bold shadow-lg disabled:cursor-not-allowed disabled:transform-none"
          >
          ...
          <div className="space-y-3">
            ...
            <div className="person-list-responsive">
              {people.map((person, index) => (
                <div
                  key={person.id}
                  className="person-item bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-200 border border-gray-100 hover:border-blue-200"
                >
